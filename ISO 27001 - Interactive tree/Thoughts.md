...
Beside the 10 Main Clauses, there is a list of 93 controls in the **Annex A** of ISO 27001 (see the corresponding .xlsx file in the documentation folder). These controls are distributed into 4 main Sections (Section 5 to Section 8) but it appears that :
